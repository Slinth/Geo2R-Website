...
(function ($) {
  ...
  $.fn.zoom = function (action) {
    ...
    if (action === 'reset') {
      ...
      this.append($('<div class="jsZoomMouse" style="display: none; position: absolute; height: 200px; width: 200px; z-index: 9999; border-radius: 200px; background-repeat: no-repeat;"/>'));
